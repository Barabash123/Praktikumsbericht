            ...
            <div className={styles.grid}>
                <div>
                    <div className={styles.gridText}>
                        <p>
                            Der Konfigurator ist ein Tool von antwerpes, der es den Kunden der
                            Agentur ermöglicht, schnell und bequem eine Kampagnenanfrage zu senden
                            und dabei deren Details und Budget anzugeben.{" "}
                        </p>
                        <p>
